...
def train(model, loss, optimizer, train_loader, val_loader):
    ...
    for batch_idx, sample in enumerate(tepoch):
        ...
        with autocast():
            pred_full, pred_1_2, pred_1_4, pred_1_8, pred_1_16 = model(rgb, sq_dep)

        # loss
        loss_value = loss(gt, pred_full, pred_1_2, pred_1_4, pred_1_8, pred_1_16)
        loss_value.backward()
...
if __name__ == "__main__":
    ...
    # dataset
    train_dataset = dataset.NYUDataset(settings.nyu_dataset_root_path, settings.nyu_train_csv, settings.sparse_density, "train")
    ...
    test_dataset = dataset.NYUDataset(settings.nyu_dataset_root_path, settings.nyu_test_csv, settings.sparse_density, "test")
